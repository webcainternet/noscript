      ...
      <div class="container">
        ...
        <div class="content content-incluso">
            ...
            <div class="row advantages">
                <div class="col-lg-4 col-md-6 col-sm-12" data-toggle="tooltip-advantages" title="" data-original-title="Every day from 7 am to midnight CET our experienced first-level support will gladly accept your call on our toll-free hotline.">
                    <img src="/templates/images/icon-support-64x64-col.png"><h4><b>Free</b><br> Support Hotline</h4>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" data-toggle="tooltip-advantages" title="" data-original-title="We don't want to pin you down to long contract terms. That's why all our servers have a minimum term of only one month.">
                    <img src="/templates/images/icon-calendar-64x64-col.png"><h4><b>No</b><br> Minimum Period</h4>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" data-toggle="tooltip-advantages" title="" data-original-title="Transfer as much data as you want! At Server4You the data volume is not limited.">
                    <img src="/templates/images/icon-traffic-64x64-col.png"><h4>Traffic<br><b>Flat Rate</b></h4>
                </div>

                <div class="col-lg-4 col-md-6 col-sm-12" data-toggle="tooltip-advantages" title="" data-original-title="Our data center datadock is not only extremely energy-efficient. It was also certified according to ISO 27001.">
                    <img src="/templates/images/icon-tree-64x64-col.png"><h4>Europe's Greenest<br><b>Data Center</b></h4>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" data-toggle="tooltip-advantages" title="" data-original-title="It's your choice: Your Server4You server is either hosted at datadock – Europe's greenest data center – or in our state-of-the-art data center in the US.">
                    <img src="/templates/images/icon-globe-64x64-col.png"><h4><b>Server Location</b><br> US or EU</h4>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" data-toggle="tooltip-advantages" title="" data-original-title="We’d like to make your server rental as easy as possible. Therefore, we don’t charge you for a whole year in advance, but offer you monthly payment.">
                    <img src="/templates/images/icon-money-64x64-col.png"><h4><b>Monthly</b><br> Payment</h4>
                </div>
            </div>
        </div>
      </div>
